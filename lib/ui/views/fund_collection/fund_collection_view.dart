...
import 'fund_collection_viewmodel.dart';

class FundCollectionView extends StackedView<FundCollectionViewModel> {
  const FundCollectionView({Key? key}) : super(key: key);

  @override
  Widget builder(
    BuildContext context,
    FundCollectionViewModel viewModel,
    Widget? child,
  ) {
    return Scaffold(
  ...
  @override
  FundCollectionViewModel viewModelBuilder(
    BuildContext context,
  ) =>
